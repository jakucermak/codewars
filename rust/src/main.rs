...
fn main() {
    ...
    println!("{:?}", contamination::contamination("abc abc", "y"));
    assert_eq!(roman_numerals::num_as_roman(1990), "MCMXC");
    assert_eq!(all_star_code_challange::rotate("hello"), vec!["elloh", "llohe", "lohel", "ohell", "hello"]);
}